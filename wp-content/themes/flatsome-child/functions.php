...
return '<span class="lien-he-price"></span>';
}
...
function my_acf_init() {
    ...
    acf_update_setting('google_api_key', 'AIzaSyB8Hu8eSWm3F6usngi3sN3YqzN0CgWhdc8');
}
